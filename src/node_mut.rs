    ...
    pub fn to_enum(&self) -> Result<NodeEnum> {
        unsafe {
            ...
            match self {
                ...
                NodeMut::RangeTblRef(n) => Ok(NodeEnum::RangeTblRef(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::DiscardStmt(n) => Ok(NodeEnum::DiscardStmt(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::CheckPointStmt(n) => Ok(NodeEnum::CheckPointStmt(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::ParamRef(n) => Ok(NodeEnum::ParamRef(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::AStar(n) => Ok(NodeEnum::AStar(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::SortGroupClause(n) => Ok(NodeEnum::SortGroupClause(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::RowMarkClause(n) => Ok(NodeEnum::RowMarkClause(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::CallContext(n) => Ok(NodeEnum::CallContext(*n.as_ref().ok_or(err)?)),
                NodeMut::Integer(n) => Ok(NodeEnum::Integer(*n.as_ref().ok_or(err)?)),
                NodeMut::Float(n) => Ok(NodeEnum::Float(n.as_ref().ok_or(err)?.clone())),
                NodeMut::Boolean(n) => Ok(NodeEnum::Boolean(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::JsonFormat(n) => Ok(NodeEnum::JsonFormat(*n.as_ref().ok_or(err)?)),
                NodeMut::JsonReturning(n) => Ok(NodeEnum::JsonReturning(*n.as_ref().ok_or(err)?)),
                ...
                NodeMut::SinglePartitionSpec(n) => Ok(NodeEnum::SinglePartitionSpec(*n.as_ref().ok_or(err)?)),
